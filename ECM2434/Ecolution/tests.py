...
class LoginTestCase(TestCase):
    ...
    ## As a user, I can login with correct user and password
    ...
    ## As a user, I cannot login with correct user but incorrect password
    ...
    ## As a user, I cannot login with incorrect email and correct password
...
class SignupTestCase(TestCase):
    ...
    def test_signup_invalid_email(self):
        ...
        # check if the user is redirected after successful signup
        self.assertNotRedirects(response, '/')  # TODO: adjust the redirect URL (e.g., home page or login page)
